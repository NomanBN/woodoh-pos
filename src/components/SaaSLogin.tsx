...
export default function SaaSLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!isStaff) {
        throw new Error('الوصول مقتصر على موظفي Wodoh Tech فقط.');
      }
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4 font-sans" dir="rtl">
      ...
      >
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-black text-gray-900 tracking-tight">Wodoh Tech</h1>
          <p className="text-gray-500 font-bold mt-2">بوابة وصول المشرف العام (SaaS Portal)</p>
        </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      placeholder="name@wodohtech.com"
                      required
                    />
                  </div>
                </div>
        ...
        <div className="mt-8 text-center text-gray-400 text-[10px] font-black uppercase tracking-[0.2em]">
          &copy; 2026 Wodoh Tech SaaS Management System
        </div>
      </motion.div>
    </div>
  );
