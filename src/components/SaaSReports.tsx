...
export default function SaaSReports() {
  const stats = [
    { label: 'إجمالي الإيرادات', value: 'SAR 125,400', trend: '+12.5%', icon: DollarSign, color: 'text-emerald-600', bg: 'bg-emerald-50' },
    { label: 'متوسط قيمة العميل (ARPU)', value: 'SAR 450', trend: '+5.2%', icon: Users, color: 'text-indigo-600', bg: 'bg-indigo-50' },
    ...
    <div className="space-y-8 font-sans" dir="rtl">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 font-bold mt-1">تحليل الأداء المالي لمنصة Wodoh Tech</p>
        </div>
