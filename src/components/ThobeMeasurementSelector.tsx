...
export default function ThobeMeasurementSelector({ values, onChange }: ThobeMeasurementSelectorProps) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 p-8 bg-white rounded-[3rem] border border-slate-100 shadow-[0_32px_64px_-12px_rgba(0,0,0,0.08)] relative overflow-hidden" dir="rtl">
      {/* Visual SVG Section */}
      <div className="flex-1 flex flex-col items-center justify-center bg-slate-50/50 rounded-[2.5rem] p-12 min-h-[900px] relative border border-slate-100/50">
        ...
        <div className="mt-8 text-center">
          <p className="text-[10px] font-black text-content-muted uppercase tracking-[0.3em]">
