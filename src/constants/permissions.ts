...
export const SYSTEM_PERMISSIONS: Permission[] = [
  ...
  // Staff & Settings
  { id: 'staff.manage', name: 'إدارة الموظفين', description: 'السماح بإضافة وتعديل صلاحيات الموظفين', category: 'الإعدادات' },
  ...
  { id: 'settings.billing', name: 'إدارة الاشتراك', description: 'السماح بترقية أو إلغاء الاشتراك وفواتير Woodoh', category: 'الإعدادات' },
  ...
  { id: 'branches.manage', name: 'إدارة الفروع', description: 'السماح بإضافة وتعديل الفروع', category: 'الإعدادات' },
