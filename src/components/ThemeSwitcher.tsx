...
const ThemeSwitcher: React.FC = () => {
  ...
  const themes: { id: ThemeType; name: string; icon: any; color: string; iconColor: string }[] = [
    { id: 'light', name: t('themes.light', 'Light'), icon: Sun, color: 'bg-white', iconColor: 'text-orange-500' },
    { id: 'dark', name: t('themes.dark', 'Dark'), icon: Moon, color: 'bg-slate-900', iconColor: 'text-blue-400' },
    { id: 'elegant', name: t('themes.elegant', 'Elegant'), icon: Palette, color: 'bg-[#F5F2ED]', iconColor: 'text-[#5A5A40]' },
